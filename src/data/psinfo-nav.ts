...
export const MODULES: NavModule[] = [
  ...
  },
  {
    ...
    pages: [
      { id: 'progress-indicators', label: 'Progress Indicators', route: '/prototypes/progress-indicators' },
...
export const SEARCH_INDEX: SearchEntry[] = [
  ...
  { title: 'Floodplains & Estuaries', subtitle: 'Topic · pressure indicators', category: 'Progress', route: '/prototypes/progress-indicators' },
  { title: 'On-site Sewage Systems', subtitle: 'Topic · pressure indicators', category: 'Progress', route: '/prototypes/progress-indicators' },
  { title: 'Progress Indicators', subtitle: 'Measures of human activities that influence ecosystem health', category: 'Progress', route: '/prototypes/progress-indicators' },
